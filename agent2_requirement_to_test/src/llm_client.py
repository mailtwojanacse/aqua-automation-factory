"""LLM wrapper for Agent 2's test-case generation step. Four backends,
selected via the LLM_BACKEND env var:
...
def generate(system_prompt, user_prompt, model=None, max_tokens=4000):
